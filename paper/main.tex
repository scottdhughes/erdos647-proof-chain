...
\paragraph{Related work.} The state of the art on prime factors of consecutive integers is
Tao--Ter\"av\"ainen~\cite{TaoTeravainen2025}, which resolves several neighbouring Erd\H{o}s
problems by the Maynard sieve and Pilatte's correlation estimates for bounded multiplicative
functions, yet leaves \#647 open, in the prime-tuples class. Adjacent results on divisor
correlations in almost all short intervals~\cite{PliegoSunWang} and on the distribution of
$d(n+1)/d(n)$~\cite{SchlagePuchta} are average statements and do not bound the pointwise count
$\C(x)$.
...
\bibitem{PliegoSunWang}
J. Pliego, Y.-C. Sun, and M. Wang,
\emph{Local divisor correlations in almost all short intervals},
arXiv:2503.02962 (2025).

\bibitem{SchlagePuchta}
J.-C. Schlage-Puchta,
\emph{On a problem by Erd\H{o}s and Mirsky on the ratio of the number of divisors of
consecutive integers}, arXiv:2504.11463 (2025).
